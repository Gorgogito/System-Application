...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<DocumentConcept> DocumentConcepts => Set<DocumentConcept>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BoardTask>(e =>
        {
            ...
            e.Property(x => x.DueDate).IsRequired(false);
            e.Property(x => x.AlertHoursBeforeDue).IsRequired(false);
        ...
        modelBuilder.Entity<ResetMonthLog>(e =>
        {
            e.HasKey(x => x.Id);
            e.ToTable("ResetMonthLog");
        ...
        modelBuilder.Entity<Attachment>(e =>
        {
            ...
            e.Property(x => x.OriginalName).IsRequired().HasMaxLength(255);
            ...
            e.HasOne(x => x.DocumentConcept)
             .WithMany(c => c.Attachments)
             .HasForeignKey(x => x.DocumentConceptId)
             .OnDelete(DeleteBehavior.SetNull)
             .IsRequired(false);
        });
    }
